...
const DeleteProject = (data) => APIWithToken.post("/projects/delete", data);
const DeleteFind = (data) => APIWithToken.post("/finds/delete", data);
const DeleteSource = (data) => APIWithToken.post("/sources/delete", data);
