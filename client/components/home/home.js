        ...
        <main className="dark:bg-gray-800 w-10/12 m-auto bg-white relative overflow-hidden">
                ...
                <div className="bg-white dark:bg-gray-800 flex relative z-20 items-center overflow-hidden">
                    <div className="container mx-auto items-center justify-center px-6 flex relative py-16">
                        <div className="sm:w-3/3 lg:w-3/5 flex flex-col relative z-20">
                        ...
                        <div className="hidden sm:block sm:w-1/3 lg:w-3/5 relative">
                            <img src="/img/home.svg" className=

                                "lg:block hidden max-w-xs md:max-w-sm m-auto" />
                        </div>
                    </div>
                </div>
            {/* </Fade> */}
...
function Page({ img, rev, title, text, link }) {
    return (
        <main className="dark:bg-gray-800 w-12/12 bg-white  overflow-hidden">
            <div className="bg-white dark:bg-gray-800 flex relative z-20 items-center overflow-hidden">
                <div className={`container mx-auto px-6 flex relative items-center justify-center py-16 ${rev && 'flex-row-reverse'}`}>
                    <div className="sm:w-2/3 lg:w-2/5 w-full flex flex-col relative z-20">
                        ...
                        <div className="flex mt-8">
                            <a href={link} className="uppercase py-2 px-4 rounded-lg bg-sky-700 border-2 border-transparent text-white text-md mr-4 hover:bg-sky-800">
                                Get started
                            </a>

                        </div>
                    </div>
                    <div className="hidden sm:block sm:w-3/3 lg:w-3/5 relative">
                        <img src={img} className="max-w-xs md:max-w-sm m-auto lg:block hidden" />
                    </div>
                </div>
            </div>
        </main>
